...
import co.simplon.alt3.kisslulerback.KissLulerBackApplication;
...
public class PropertiesLoader {
  ...
  public static Properties loadProperties(String resourceFileName) throws IOException {
    final InputStream inputStream = KissLulerBackApplication.class.getResourceAsStream(resourceFileName);
